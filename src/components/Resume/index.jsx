        ...
        <div className="resume--grid--detail">
          ...
          <div className="resume--grid--detail--data">
            <div className="resume--grid--detail--data--name">
              <h2>
                <ParaWriting stagger={0.08} text={"Shaqeal Jinnah"} />
              </h2>
              <h4>
              ...
              <motion.div initial="hidden" animate={controls} variants={blurVariants} transition={{ duration: 1, delay: 0.5 }} onAnimationComplete={() => handleComplete()} className="resume--grid--detail--data--name--icons">
                <a href="https://github.com/shaqealjinnah" target="_blank" rel="noreferrer">
                  <Icon img={githubIcon} />
                </a>
                <a href="https://www.linkedin.com/in/shaqeal-jinnah-193588321/" target="_blank" rel="noreferrer">
                  <Icon img={linkedinIcon} />
                </a>
                <a href="./shaqeal-resume.pdf" target="_blank" rel="noreferrer">
                  <Icon img={fileIcon} />
                </a>
              </motion.div>
            </div>
            ...
            <div className="resume--grid--detail--data--skills">
              <h4>
                <ScrambleText delay={0}>Soft Skills</ScrambleText>
              </h4>
